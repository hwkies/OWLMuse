...
IF OBJECT_ID('dbo.HeroData_2021', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.HeroData_2022', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.HeroData_2023', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.PHS_2018', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.PHS_2019', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.PHS_2020', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.PHS_2021', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.PHS_2022', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.PHS_2023', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.Match_Map_Stats', 'U') IS NULL
BEGIN
